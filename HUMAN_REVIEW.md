...
| `src/Broiler.VM.Profile.JavaScript.Compiler/JsCompiler.cs` | 251 | 167 | 84 | 167 | None | High | 7/6 |
| `src/Broiler.VM.Profile.JavaScript.Compiler/JsParser.cs` | 143 | 126 | 17 | 126 | None | High | 2/2 |
...
| `src/Broiler.VM.Profile.JavaScript.Format/JsOpcode.cs` | 149 | 23 | 126 | 23 | None | Medium | 0/0 |
...
| `src/Broiler.VM.Profile.JavaScript/JsEngine.cs` | 134 | 119 | 15 | 119 | Low | High | 20/20 |
...
- `Broiler.VM.Profile.JavaScript.JsEngine.ImportedModule(JsProgram, string, string)` in `src/Broiler.VM.Profile.JavaScript/JsEngine.cs` - Security=High, Spec=none cited, `FF2EDC`, PENDING
