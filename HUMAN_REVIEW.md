...
> **Status: PENDING.** Human-reviewed: 0 of 2645 relevant units. No package
...
| `src/Broiler.VM.Profile.JavaScript.Compiler/JsCompiler.cs` | 263 | 179 | 84 | 179 | None | High | 11/10 |
| `src/Broiler.VM.Profile.JavaScript.Compiler/JsParser.cs` | 162 | 143 | 19 | 143 | None | High | 3/3 |
...
That is not a figure of speech. 2645 of the 2645 assessed units declare
