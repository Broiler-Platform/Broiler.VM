...
> **Status: PENDING.** Human-reviewed: 0 of 2364 relevant units. No package
...
| Relevant | 2364 |
| Exempt | 1964 |
| Assessed | 2364 of 2364 (100%) |
| Human reviewed | 0 of 2364 (0%) |
| Unverified | 2364 |
...
- `Broiler.VM.Profile.JavaScript.JsEngine.Delegate(JsFrame, JsValue[], ref int, int)` in `src/Broiler.VM.Profile.JavaScript/JsEngine.cs` - Security=High, Spec=none cited, `F0AF03`, PENDING
...
That is not a figure of speech. 2364 of the 2364 assessed units declare
