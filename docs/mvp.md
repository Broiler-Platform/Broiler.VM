...
**MVP-10 and MVP-11 are the universal bytecode programme's first routes, and MVP-10 is the one a
...
and the primitive is checked against it, not the other way round. Neither row settles anything, and
the programme's later routes (the concept's UBC-R3 to UBC-R9) are filed here by the milestone that
takes each, not before.
