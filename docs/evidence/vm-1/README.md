...
| `rules.register.json` | 53 rules: **48 Active, 1 Vacuous, 4 Deferred** |
...
| EX-77 | Open | **Fifteen of the sixty-nine criteria are new prose, not migrated prose.** The criteria were meant to carry across the wording of the twenty-two code-only worksheet items, whose text was the product of real thought about this code. Most did. Fifteen did not, because the units they sit on had no worksheet item - the largest block being the nine on `VmProfileId`, seven of them on `High` units, where the worksheet named nothing at all. Those fifteen have had no more scrutiny than any other sentence written in this change, and a reviewer should read them as new claims rather than as reviewed ones. |
