...
to two when the lane was brought back to ADR 0012's declared matrix, and the third widened again
when that matrix gained `linux-arm64` — declared for the architecture, and standing for no other
RID.*
