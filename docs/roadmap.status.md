...
snapshot, **VM-0 through VM-5 are all in progress and unaccepted, and VM-6 is not started.**
...
[docs/baselines.md](baselines.md), and a fourteen-project graph that implements core contract
...
the JIT and Native AOT lanes, and 304 tests passed: 107 architecture and 197 behavioural.

**No milestone is accepted, and none can be until a human signs.** VM-0 through VM-5 are all
