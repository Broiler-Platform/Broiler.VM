...
to two when the lane was brought back to ADR 0012's declared matrix, and the third, fourth and
fifth widened it to six — every cell of a three-toolchain by two-architecture grid, `osx-arm64`
included, which that morning's withdrawal had removed and the afternoon's argument readmitted. Each
stands for no other RID.*
