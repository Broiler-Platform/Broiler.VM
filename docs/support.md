...
below claims more because of it, and no figure from it is copied here.)* Every cell of the table below states what has been demonstrated **on retained evidence**,
...
and that observation claims no identifier.)* A reader who takes anything below as a claim about a runtime
