...
`public` — which this front end does not have at all; [JSC-245](#jsc-245) records that separately,
...
[JSC-244](#jsc-244). Forty-four variants across those families pass that did not, and none that
...
variants to 551 of 557** together with [JSC-243](#jsc-243), and
...
[JSC-243](#jsc-243)'s. Two name-inference variants that had been failing —
...
of the destructuring families [JSC-241](#jsc-241) closed the rest of, because those spell the word
