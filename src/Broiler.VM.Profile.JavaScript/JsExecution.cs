...
internal static class JsExecution
{
    ...
    /// call, which on 2026-09-04 is <b>3,479 bytes</b> - the executor's own frame having grown as
    ...
    /// this figure exists to prevent. Sixty-four megabytes holds 19,288, which is more than
