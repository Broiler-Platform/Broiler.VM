...
/// </para>
/// <para>
/// <b>What it refuses, it refuses by name.</b> The wide manifest admits no class,
...
/// refused; <c>async function*</c> is still refused and is now named as an async GENERATOR function
/// rather than as an async one, which is a narrower name for the same code and the same position.
