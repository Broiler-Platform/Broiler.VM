...
//
// The well-known key is spelled portably. This surface has no Symbol primitive yet - JSW-6 owns
// that - so the protocol is keyed on the string `@@iterator` until one exists, and a source
// written this way names the same method on either.
var ITERATOR = typeof Symbol !== "undefined" && Symbol.iterator ? Symbol.iterator : "@@iterator";
var log = [];
