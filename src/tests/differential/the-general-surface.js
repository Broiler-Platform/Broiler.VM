...
// --- the error objects, the global functions, the Object statics, the function objects and the
// Array, one corner at a time. APPENDED for the reason the numbering asks. It is the pass that
// found `AggregateError`, `Object.fromEntries`, `Object.groupBy` and `Map.groupBy` absent, and a
// strict `arguments.callee` answering with the function instead of throwing.
p(function(){ return new Error("m").message + "," + new Error("m").name; });
p(function(){ return String(new TypeError("t")); });
p(function(){ return Object.prototype.toString.call(new RangeError()); });
p(function(){ return new Error("m", {cause: 42}).cause; });
p(function(){ return String("cause" in new Error("m")); });
p(function(){ return typeof AggregateError; });
p(function(){ try { new AggregateError([new Error("a")], "m").errors.length; return String(new AggregateError([1,2],"m").errors.length); } catch(e){ return e.name; } });
p(function(){ return String(new Error("x").stack !== undefined); });
p(function(){ return String(Error.prototype.message) + "," + String(Error.prototype.name); });
p(function(){ var e = new Error(); return String(e.message === "") + "," + String(e.hasOwnProperty("message")); });
p(function(){ return String(new TypeError() instanceof Error) + String(Object.getPrototypeOf(TypeError) === Error); });
p(function(){ try { null.x; } catch(e) { return e.constructor.name; } });
p(function(){ try { undefinedFn(); } catch(e) { return e.constructor.name; } });
p(function(){ try { (1)(); } catch(e) { return e.name; } });
p(function(){ try { new Array(-1); } catch(e) { return e.name; } });
p(function(){ return Error.length + "," + TypeError.length; });
p(function(){ return encodeURIComponent("a b&c=d/e?"); });
p(function(){ return encodeURI("http://a.b/c d?e=f&g#h"); });
p(function(){ return decodeURIComponent("%20%26"); });
p(function(){ try { decodeURIComponent("%"); return "no-throw"; } catch(e){ return e.name; } });
p(function(){ return encodeURIComponent("é") + "," + encodeURIComponent("😀"); });
p(function(){ return String(isNaN("x")) + isFinite("1") + isNaN(undefined); });
p(function(){ return String(globalThis === this) + typeof globalThis; });
p(function(){ return typeof escape + typeof unescape; });
p(function(){ return [typeof parseInt, typeof parseFloat, typeof Boolean, typeof String].join(); });
p(function(){ return String(Object.getOwnPropertyDescriptor(globalThis, "undefined").writable); });
p(function(){ return String(Object.getOwnPropertyDescriptor(globalThis, "NaN").configurable); });
p(function(){ return String(globalThis.Infinity) + "," + String(-globalThis.Infinity); });
p(function(){ return JSON.stringify(Object.entries({a:1,b:2})); });
p(function(){ return JSON.stringify(Object.fromEntries([["a",1]])); });
p(function(){ return JSON.stringify(Object.assign({}, {a:1}, {b:2})); });
p(function(){ return JSON.stringify(Object.values({a:1,b:2})); });
p(function(){ return String(Object.is(NaN, NaN)) + Object.is(0, -0); });
p(function(){ var o = Object.seal({a:1}); o.b = 2; return JSON.stringify(o) + Object.isSealed(o); });
p(function(){ return String(Object.isFrozen(Object.freeze({}))); });
p(function(){ return typeof Object.groupBy; });
p(function(){ return JSON.stringify(Object.getOwnPropertyDescriptors({a:1})); });
p(function(){ return Object.keys("ab").join(); });
p(function(){ return String(Object.entries([1,2]).length); });
p(function(){ try { Object.defineProperty(1, "x", {}); return "no-throw"; } catch(e){ return e.name; } });
p(function(){ return JSON.stringify(Object.create(null, {a:{value:1,enumerable:true}})); });
p(function(){ return Object.keys(Object.assign({}, "ab")).join(); });
p(function(){ function f(a,b){ return this.v + a + b; } return f.call({v:1}, 2, 3) + "," + f.apply({v:1},[2,3]); });
p(function(){ function f(a,b){ return a+b; } var g = f.bind(null, 1); return g(2) + "," + g.length + "," + g.name; });
p(function(){ function f(){ return new.target === undefined; } return String(f()); });
p(function(){ function F(){ this.x = 1; } var B = F.bind(null); return new B().x; });
p(function(){ return (function(){ return arguments.length; })(1,2,3); });
p(function(){ return (function(a,b){ return arguments.callee ? "callee" : "none"; })(1); });
p(function(){ "use strict"; try { return (function(){ return arguments.callee; })(); } catch(e){ return e.name; } });
p(function(){ return String(Function.prototype.call.length) + Function.prototype.apply.length + Function.prototype.bind.length; });
p(function(){ return (function f(){}).hasOwnProperty("prototype") + "," + (()=>{}).hasOwnProperty("prototype"); });
p(function(){ return String(Object.getPrototypeOf(function(){}) === Function.prototype); });
p(function(){ return typeof Function.prototype(); });
p(function(){ var o = {m(){ return typeof super.toString; }}; return "skip"; });
p(function(){ return [].constructor === Array ? "array-ctor" : "no"; });
p(function(){ var a = [1,,3]; return a.length + "," + (1 in a) + "," + a.join("-"); });
p(function(){ var a = [1,,3]; var seen = []; a.forEach(function(x,i){ seen.push(i); }); return seen.join(); });
p(function(){ return JSON.stringify([1,,3]); });
p(function(){ var a = [3,1,2]; return a.sort().join() + "," + [10,9].sort().join(); });
p(function(){ return [1,2,3].sort(function(a,b){ return b-a; }).join(); });
p(function(){ return [1,[2,[3,[4]]]].flat(2).join(); });
p(function(){ return [1,2].flatMap(function(x){ return [x,x*2]; }).join(); });
p(function(){ return Array.from({length:3}, function(_,i){ return i*2; }).join(); });
p(function(){ return Array.of(7).join() + "," + Array(3).length; });
p(function(){ return [1,2,3].copyWithin(0,1).join(); });
p(function(){ return [1,2,3].at(-1) + "," + [1,2,3].findLast(function(x){return x<3;}); });
p(function(){ return [1,2,3].toReversed().join() + "|" + [3,1,2].toSorted().join() + "|" + [1,2,3].with(0,9).join(); });
p(function(){ return [1,2,3].toSpliced(1,1).join(); });
p(function(){ return String([].includes(undefined)) + [,].includes(undefined); });
p(function(){ return [1,2,3].reduce(function(a,b){return a+b;}) + "," + [].reduce(function(a,b){return a+b;}, 5); });
p(function(){ try { [].reduce(function(a,b){return a;}); return "no-throw"; } catch(e){ return e.name; } });
p(function(){ var a = [1,2,3]; a.length = 1; return a.join(); });
p(function(){ var a = []; a[4294967294] = 1; return a.length; });
p(function(){ return String(Array.isArray([])) + Array.isArray({length:0}); });
p(function(){ return [1,2,3].indexOf(2) + "," + [1,2,3].lastIndexOf(3) + "," + [NaN].indexOf(NaN) + "," + [NaN].includes(NaN); });
p(function(){ return ["b","a"].sort().join() + "," + [2,10,1].sort().join(); });
p(function(){ return [1,2,3].slice(-2).join() + "," + [1,2,3].splice(1,1).join(); });
p(function(){ var a=[1,2,3]; a.splice(1,0,9); return a.join(); });
p(function(){ return [..."abc"].join() + "," + Array.from("abc").join(); });
p(function(){ return [1,2].concat([3],[4,[5]]).length; });
p(function(){ return [0, -0].lastIndexOf(-0) + "," + [1,2,3].fill(0,1).join(); });
p(function(){ return JSON.stringify(Object.groupBy([1,2,3,4], function(x){ return x%2 ? "odd":"even"; })); });
p(function(){ var g = Object.groupBy([1], function(){ return "toString"; }); return String(Object.getPrototypeOf(g)) + "," + g.toString.length; });
p(function(){ var m = Map.groupBy([1,2,3], function(x){ return x%2; }); return m.size + "," + m.get(1).join(); });
p(function(){ var k = {}; var m = Map.groupBy([1], function(){ return k; }); return String(m.get(k).length); });
p(function(){ return JSON.stringify(Object.fromEntries(new Map([["a",1]]))); });
p(function(){ return JSON.stringify(Object.fromEntries([["a",1],["b",2]])); });
p(function(){ var o = Object.fromEntries([["__proto__", 1]]); return String(Object.getPrototypeOf(o) === Object.prototype) + "," + o.__proto__; });
p(function(){ try { Object.fromEntries([1]); return "no-throw"; } catch(e){ return e.name; } });
p(function(){ return Object.fromEntries.length + "," + Object.groupBy.length + "," + Map.groupBy.length; });
p(function(){ return typeof AggregateError + "," + new AggregateError([1,2],"m").errors.join() + "," + new AggregateError([],"m").message; });
p(function(){ var e = new AggregateError(new Set([1]), "m"); return e.errors.length + "," + e.name + "," + String(e instanceof Error); });
p(function(){ return String(Object.getPrototypeOf(AggregateError) === Error) + "," + AggregateError.length; });
p(function(){ return String(Object.getOwnPropertyDescriptor(new AggregateError([],"x"), "errors").enumerable); });
p(function(){ "use strict"; try { return (function(){ return arguments.callee; })(); } catch(e){ return e.name; } });
p(function(){ "use strict"; return String("callee" in (function(){ return arguments; })()); });
p(function(){ return typeof (function(){ return arguments; })().callee; });
p(function(){ "use strict"; var a = (function(){ return arguments; })(); return String(Object.getOwnPropertyDescriptor(a, "callee").get === Object.getOwnPropertyDescriptor(a, "callee").set); });
