...
/// <remarks>
/// <para>
/// <b>THIS FILE IS COPIED FROM
/// <c>Broiler.VM.Composition.JavaScript.Cli/SourceProvider.cs</c>, apart from the namespace and
/// the caller identity it presents.</b> Rules A11 and A12 leave such code nowhere else, so a
/// second end-user host copies rather than references, and the copy is recorded here rather than
/// left to be discovered. What a provider answers is a content policy, and two hosts of the same
/// profile answering it differently without saying so would be the drift this note exists to
/// prevent.
/// </para>
/// <para>
...
internal sealed class SourceProvider : IVmArtifactProvider
{
    ...
    public VmArtifactProviderAnswer Answer(scoped in VmArtifactRequest request)
    {
        ...
        var descriptor = new VmArtifactDescriptor(
            ...
            default,
            VmCallerIdentity.FromCanonicalIdentity("broiler-cli://source-provider"));
