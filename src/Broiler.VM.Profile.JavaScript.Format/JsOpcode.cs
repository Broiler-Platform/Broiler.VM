...
/// </para>
/// <para>
/// <b>The set is deliberately not complete JavaScript.</b> There is no <c>await</c>; it is a
/// construct the manifest refuses at the front end rather than an opcode the executor would have
/// to answer for. What is here is what a program that runs has to have.
/// </para>
/// <para>
